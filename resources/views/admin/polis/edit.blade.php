            ...
            <form action="{{ route('polis.update', $poli->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama_poli" value="{{ old('nama_poli', $poli->nama_poli) }}"
                        placeholder="Masukkan nama poli..." class="w-full px-4 py-2 rounded-lg border-2 border-slate-300
                               focus:border-primary focus:outline-none
                               @error('nama_poli') border-red-500 @enderror" required>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="keterangan" rows="4" placeholder="Masukkan keterangan poli..." class="w-full px-4 py-2 rounded-lg border-2 border-slate-300
                               focus:border-primary focus:outline-none
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('polis.index') }}" class="px-6 py-2.5 rounded-lg bg-slate-100 hover:bg-slate-200
