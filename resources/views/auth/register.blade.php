    ...
    <div class="card bg-base-100 shadow-2xl rounded-2xl w-full max-w-[480px]">
        <div class="card-body p-[40px]">
            ...
            <div class="text-center mb-7">
                ...
                <h1 class="text-[1.5rem] font-extrabold text-[#ffffff] m-0 mb-[6px]">Poliklinik</h1>
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-control mb-4">
                    ...
                    <label
                        class="input input-bordered flex items-center gap-3 w-full rounded-[10px] border-slate-200 bg-slate-50">
                ...
                <div class="grid grid-cols-2 gap-[14px] mb-4">
                    <div class="form-control">
                        ...
                        <label
                            class="input input-bordered flex items-center gap-2 rounded-[10px] border-slate-200 bg-slate-50">
                            <i class="fas fa-phone text-slate-400 text-[0.78rem]"></i>
                            <input type="number" name="no_hp" value="{{ old('no_hp') }}" placeholder="No. HP..."
                                class="grow bg-transparent text-slate-800 text-[0.85rem]" required>
                        </label>
                    </div>
                    <div class="form-control">
                        <label class="label pb-1">
                        ...
                        <label
                            ...
                            <input type="number" name="no_ktp" value="{{ old('no_ktp') }}" placeholder="No. KTP..."
                                class="grow bg-transparent text-slate-800 text-[0.85rem]" required>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-control mb-4">
                    ...
                    <label
                        class="input input-bordered flex items-center gap-2 w-full rounded-[10px] border-slate-200 bg-slate-50">
                        <i class="fas fa-lock text-slate-400 text-[0.78rem]"></i>
                        <input type="password" name="password" id="password_reg" placeholder="Password..."
                            class="grow bg-transparent text-slate-800 text-[0.85rem]" required>
                ...
                <div class="form-control mb-6">
                    ...
                    <label
                        ...
                        <input type="password" name="password_confirmation" id="password_confirm"
                            placeholder="Ulangi password..." class="grow bg-transparent text-slate-800 text-[0.85rem]"
                            required>
